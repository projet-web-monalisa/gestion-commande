                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-name"><a href="#"><?= $produit->nom ?></a></td>
                                            <td class="product-price"><span class="amount"><?= $produit->prix ?></span></td>
                                                    <?php $pos=array_search($produit->idProduit,$_SESSION['panier']['idProduit']); ?>

                                            <td class="product-quantity">
                                             <a  href="incrementarticle.php?idProduit=<?= $produit->idProduit ?>" class="btn btn-dark" > + </a>
<div class="entry value" value="">
                                                <span> <?= $_SESSION['panier']['quantite'][$pos]; ?> </span>
                                            </div>
                                             <a  href="decrementarticle.php?idProduit=<?= $produit->idProduit ?>" class="btn btn-dark" > - </a> 

</td>
<?php $prix=$produit->prix ?> <?php $quantite=$_SESSION['panier']['quantite'][$pos]; ?>

                                            <td class="product-subtotal"><?= $prix*$quantite ?></td>
                                            <td class="product-remove"><a onclick="return confirm('Are you sure you want to delete this product ?')" href="supprimerarticle.php?idProduit=<?= $produit->idProduit ?>">X</a></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
...
?>
                              ...
                              <form action="print.php">
                                <div class="buttons-cart">
                             <input type="submit" name="print" value="imprimer devis">
                         </div>
                             </form>
                    </div>
                </div>
