        ...
        <div class="row mt mb">
          <div class="col-lg-12">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="dmbox">
                <div class="service-icon">
                  <a class="" href="faq.php#"><i class="dm-icon fa fa-question fa-3x"></i></a>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="dmbox">
                <div class="service-icon">
                  <a class="" href="faq.php#"><i class="dm-icon fa fa-envelope-o fa-3x"></i></a>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="dmbox">
                <div class="service-icon">
                  <a class="" href="faq.php#"><i class="dm-icon fa fa-random fa-3x"></i></a>
                </div>
        ...
        <div class="row content-panel">
          ...
          <div class="col-md-10 col-md-offset-1 mt mb">
            <div class="accordion" id="accordion2">
              ...
              <div class="accordion-group">
                <div class="accordion-heading">
                  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="faq.php#collapseFive">
