...
<div>
    ...
    <div class="controls">
    <input class="controle" type="text" name="pseudo" required pattern="[a-zA-Z-\.]{3,12}" placeholder="saisir le nom du produit">
    </div>
    <p>
</div>
<div>
...
<div>
    ...
    <div class="controls">
    <input name="qte_prod" type="number" required pattern="[0-9]" x-moz-errormessage="La quantite doix etre des chiffres" placeholder="Quantite">
    </div>
    <p>
</div>
<div>
     <p>
       <label for="pays">saisir la categories du produit</label><br />
       <select name="categories" id="categories">
           <option value="france">suspention murale </option>
           <option value="espagne">lumiere</option>
           <option value="italie">bracelet</option>
           <option value="royaume-uni">agenda</option>
       </select>
   </p>
    </div>
    <div>
     <p>
       <label for="pays">saisir le théme du produit</label><br />
       <select name="categories" id="categories">
           <option value="france"> contemporaine</option>
           <option value="espagne">moderne</option>
           <option value="italie">chic</option>
           <option value="royaume-uni">bohemien</option>
       </select>
   </p>
    </div>
    <p>
...
<input type="submit" name="ajouter" value="Ajouter" class="btn btn-primary">&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn" href="afficherProduit.php" style="background-color:#0c2646;border-color:#0c2646; color:white;">Retour</a>
    </form>
          </div>
          <!-- /col-lg-6 -->
        </div>
