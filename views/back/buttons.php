        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="ajoucategorie.php">ajouter categorie</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
...
<div>
     <p>
       <label for="pays" value="choisir categories">saisir la categories du produit</label><br />
    ...
    <div>
     <p>
       <label for="pays" value="choisir Theme">saisir le théme du produit</label><br />
       <select name="categories" id="categories">
