      ...
      <section class="wrapper">
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <form method="POST">
<table>
<caption>Modifier Compte Client</caption>
<tr>
<td>CIN</td>
<td><input type="number" name="cin" value="CIN" required pattern="[0-9]" placeholder="CIN"></td>
</tr>
<tr>
<td>Nom</td>
<td><input name="nom" type="text"required pattern="[a-zA-Z-\.]{3,12}" placeholder="NOM"></td>
</tr>
<tr>
<td>Prenom</td>
<td><input name="prenom" type="text" required pattern="[a-zA-Z-\.]{3,12}" placeholder="PRENOM"></td>
</tr>
<tr>
<td>Email</td>
<td><input type="email" name="mail" required placeholder="mail@server.com"></td>
</tr>
<tr>
...
<tr>
<td>tel_portable</td>
<td><input type="number" name="tel_portable" required pattern="[0-9]" placeholder="NUM DE TEL"></td>
</tr>
<tr>
<td>adresse</td>
...
<tr>
<td>code_postal</td>
<td><input type="number" name="code_postal" required pattern="[0-9]" placeholder="CODE POSTAL"></td>
</tr>
<tr>
<td>password</td>
...
<td>image</td>
<td><input type="file" name="image" placeholder="images"></td>
</tr>
...
<td><input type="hidden" name="cin_ini" ></td>
</tr>
</table>
