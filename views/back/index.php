        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <span>Gestion prodit et categories</span>
              </a>
            <ul class="sub">
              <li><a href="buttons.php">ajouter produits</a></li>
              <li><a href="ajoucategorie.php">ajouter categories</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
            ...
            <ul class="sub">
              <li><a href="gestionclient.php">modifier profil</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
